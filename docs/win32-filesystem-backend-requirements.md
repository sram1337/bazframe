...
- product lifecycle beyond the accepted pre-provisioned healthy local-Skill catalog and explicit profile-membership slice, including fresh provisioning and active selection;
