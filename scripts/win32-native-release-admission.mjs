...
const OBSERVATION_BOOLEANS = Object.freeze([
  ...
  'membershipCreationReceiptLossRetained',
  ...
  'privateFileFirstVisibilityPrivate',
  'privateFileNoReplace',
  ...
  'directoryPublicationMaterializerDrained',
  'directoryPublicationMaterializerBounded',
  ...
  'operationLockFreshPrivatePersistentNamespace',
